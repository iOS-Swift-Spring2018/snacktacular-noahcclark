...
class SpotsListViewController: UIViewController {
    ...
    func signIn() {
        ...
        if authUI.auth?.currentUser == nil { //not sure why its throwing a fatal error
            //can't figure out why its "unexpectedly" finding nil when I am testing here to see if its nil
